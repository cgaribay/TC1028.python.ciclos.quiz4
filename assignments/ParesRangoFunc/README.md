...
**Importante:** El programa debe ser capaz de funcionar adecuadamente si el primer valor que pasa el usuario es mayor que el segundo y viceversa. (Revisar el tercer ejemplo de salida del programa).
